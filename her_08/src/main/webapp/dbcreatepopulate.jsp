    ...
    <body>
        ...
        <%
            ...
            try {
                ...
                con = java.sql.DriverManager.getConnection("jdbc:mysql://localhost:3306/Her", "root", "CheHer5433");
                out.println("<p>Database Her exists.</p>");
            } 
            catch (Exception e) 
            {
                out.println("<p>Result of initial DB check: </p>" + e);
                out.println("<p>Creating DB now...</p>");
                con = java.sql.DriverManager.getConnection("jdbc:mysql://localhost:3306", "root", "CheHer5433");
                stmt = con.createStatement();
                String query = "CREATE DATABASE Her";
                stmt.executeUpdate(query);
                out.println("<p>Database Her created sucessfully.</p>");
            }
